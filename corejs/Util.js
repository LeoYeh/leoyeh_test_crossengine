...
Util.cssCaculate = function (valueA, valueB, type) {
    if(valueA.indexOf("px") > -1){
        valueA = Number(valueA.substring(0, valueA.indexOf("px")));
    }
    if (valueB.indexOf("px") > -1) {
        valueB = Number(valueB.substring(0, valueB.indexOf("px")));
    }
    if (valueA.indexOf("%") > -1) {
        valueA = Number(valueA.substring(0, valueA.indexOf("%")));
    }
    if (valueB.indexOf("%") > -1) {
        valueB = Number(valueB.substring(0, valueB.indexOf("%")));
    }
